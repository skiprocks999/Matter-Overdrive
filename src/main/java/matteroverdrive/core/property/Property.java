...
/**
 * This is our Property object class. It holds a reference to the
 * {@link PropertyType} itself. Then optionally a {@link Supplier<T>} and
 * {@link Consumer<T>} for getting and setting the object value.
 *
...
public final class Property<T> {
	...
	/**
	 * Default Empty Constructor This constructor is used currently for Client-Side
	 * Construction of Container Properties.
	 *
	...
	/**
	 * Default Filled Constructor This constructor is used for common-sided
	 * construction of properties as well as
	 *
	 * @param propertyType The T {@link PropertyType} of the {@link Property}.
	 ...
	 * 
	 * @return Returns if the {@link Property} is Dirty (changed) and needs
	 *         updating.
	 */
