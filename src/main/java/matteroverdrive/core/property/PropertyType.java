...
public class PropertyType<T> implements Comparable<PropertyType<?>> {
	...
	/**
	 * The internal {@link Function} for reading the value from a
	 * {@link FriendlyByteBuf}.
	 */
	private final Function<FriendlyByteBuf, T> reader;

	/**
	 * The internal {@link BiConsumer} for writing the value to a
	 * {@link FriendlyByteBuf}.
	 */
	 ...
	 * @param reader The internal {@link Function} for reading the value from a
	 *               {@link FriendlyByteBuf}.
	 * @param writer
	 */
	 ...
	 * @param reader The internal {@link Function} for reading the value from a
	 *               {@link FriendlyByteBuf}.
	 * @param writer The internal {@link BiConsumer} for writing the value to a
	 *               {@link FriendlyByteBuf}.
	...
	/**
	 * Checks if the value of the passed Object is valid towards the T storage
	 * values T class value.
	 *
	 * @param object The passed in T value object.
	 * @return Returns whether the passed in object is an instance of the
	 *         {@link PropertyType} T values class.
	 */
	...
	/**
	 * Default compareTo implementation. By default, compares the name of this
	 * object and the provided {@link PropertyType} object using case_insensitive
	 * matching.
	 *
