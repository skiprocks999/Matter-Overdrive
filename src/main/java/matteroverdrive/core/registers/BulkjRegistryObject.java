...
public class BulkjRegistryObject<T extends IForgeRegistryEntry<T>> {

	private final HashMap<IBulkRegistryObject, RegistryObject<T>> objects = new HashMap<>();

	public BulkjRegistryObject(Function<IBulkRegistryObject, RegistryObject<T>> factory, IBulkRegistryObject[] bulkValues) {
