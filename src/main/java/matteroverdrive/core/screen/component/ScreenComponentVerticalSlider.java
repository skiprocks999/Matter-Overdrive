...
public class ScreenComponentVerticalSlider extends OverdriveScreenComponent {
	...
	public ScreenComponentVerticalSlider(GenericScreen<?> gui, int x, int y,
	...
	protected boolean isPointInRegion(int mouseX, int mouseY) {
		return mouseX > this.x && mouseX < this.x + width && mouseY >= this.y + 2 + sliderYOffset && this.y <= this.y + 2 + sliderYOffset + 15;
	}
