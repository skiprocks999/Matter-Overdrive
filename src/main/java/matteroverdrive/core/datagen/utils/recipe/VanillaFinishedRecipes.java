/**
 * Taken from Commable under MIT license 
 * 
 * https://github.com/Commoble/tubesreloaded/blob/main/src/datagen/java/commoble/tubesreloaded/RecipeHelpers.java
 */
...
public class VanillaFinishedRecipes {
