...
public class TileRegistry {
	...
	public static final RegistryObject<BlockEntityType<TileTritaniumCrate>> TILE_TRITANIUM_CRATE = TILES
			.register("tritanium_crate", () -> new BlockEntityType<>(TileTritaniumCrate::new,
					Sets.newHashSet(BlockRegistry.BLOCK_TRITANIUM_CRATES.<Block>getObjectsAsArray(new Block[0])), null));
	public static final RegistryObject<BlockEntityType<TileSolarPanel>> TILE_SOLAR_PANEL = TILES.register(
			...
			() -> new BlockEntityType<>(TileSolarPanel::new, Sets.newHashSet(BlockRegistry.BLOCK_SOLAR_PANEL.get()), null));
	...
	public static final RegistryObject<BlockEntityType<TileMatterRecycler>> TILE_MATTER_RECYCLER = TILES.register(
			...
			() -> new BlockEntityType<>(TileMatterRecycler::new, Sets.newHashSet(BlockRegistry.BLOCK_MATTER_RECYCLER.get()), null));
	...
	public static final RegistryObject<BlockEntityType<TileMicrowave>> TILE_MICROWAVE = TILES.register(
			...
			() -> new BlockEntityType<>(TileMicrowave::new, Sets.newHashSet(BlockRegistry.BLOCK_MICROWAVE.get()), null));
	public static final RegistryObject<BlockEntityType<TileInscriber>> TILE_INSCRIBER = TILES.register(
			TypeMachine.INSCRIBER.id(),
			() -> new BlockEntityType<>(TileInscriber::new, Sets.newHashSet(BlockRegistry.BLOCK_INSCRIBER.get()), null));
	...
	public static final RegistryObject<BlockEntityType<TileTransporter>> TILE_TRANSPORTER = TILES.register(
			...
			() -> new BlockEntityType<>(TileTransporter::new, Sets.newHashSet(BlockRegistry.BLOCK_TRANSPORTER.get()), null));
	...
	public static final RegistryObject<BlockEntityType<TileChunkloader>> TILE_CHUNKLOADER = TILES.register(
			...
			() -> new BlockEntityType<>(TileChunkloader::new, Sets.newHashSet(BlockRegistry.BLOCK_CHUNKLOADER.get()), null));
	public static final RegistryObject<BlockEntityType<TileMatterAnalyzer>> TILE_MATTER_ANALYZER = TILES.register(
			...
			() -> new BlockEntityType<>(TileMatterAnalyzer::new, Sets.newHashSet(BlockRegistry.BLOCK_MATTER_ANALYZER.get()), null));
	public static final RegistryObject<BlockEntityType<TilePatternStorage>> TILE_PATTERN_STORAGE = TILES.register(
			...
			() -> new BlockEntityType<>(TilePatternStorage::new, Sets.newHashSet(BlockRegistry.BLOCK_PATTERN_STORAGE.get()), null));
	public static final RegistryObject<BlockEntityType<TilePatternMonitor>> TILE_PATTERN_MONITOR = TILES.register(
			...
			() -> new BlockEntityType<>(TilePatternMonitor::new, Sets.newHashSet(BlockRegistry.BLOCK_PATTERN_MONITOR.get()), null));
