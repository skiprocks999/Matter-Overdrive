...
public class RecipeCategoryMicrowave extends CookingRecipeCategory<SmokingRecipe> {
	...
	private static final PowerUsageLabelWrapper POWER_USE = new PowerUsageLabelWrapper(UtilsRendering.HOLO_RED, 50, 40).setConstUsage(TileMicrowave.USAGE_PER_TICK);
	private static final PowerConsumedLabelWrapper POWER_CONSUMED = new PowerConsumedLabelWrapper(UtilsRendering.HOLO_RED, 50, 52).setConstUsage(TileMicrowave.USAGE_PER_TICK);
