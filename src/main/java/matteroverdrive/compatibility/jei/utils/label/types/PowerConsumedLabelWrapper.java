...
public class PowerConsumedLabelWrapper extends GenericLabelWrapper {
	...
	public PowerConsumedLabelWrapper(int color, int xPos, int yPos) {
		super(color, xPos, yPos, "powerconsumed");
	}
	
	public PowerConsumedLabelWrapper setConstUsage(double usage) {
		constPowerUsage = true;
		constPower = usage;
		return this;
	}
	
	public PowerConsumedLabelWrapper setConstTime(double time) {
		constantTime = true;
		this.time = time;
		return this;
	}
