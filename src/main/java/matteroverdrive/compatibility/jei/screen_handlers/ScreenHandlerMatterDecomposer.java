...
public class ScreenHandlerMatterDecomposer implements IGuiContainerHandler<ScreenMatterDecomposer> {

	@Override
	public List<Rect2i> getGuiExtraAreas(ScreenMatterDecomposer containerScreen) {
