...
public class ScreenHandlerSolarPanel implements IGuiContainerHandler<ScreenSolarPanel> {

	@Override
	public List<Rect2i> getGuiExtraAreas(ScreenSolarPanel containerScreen) {
