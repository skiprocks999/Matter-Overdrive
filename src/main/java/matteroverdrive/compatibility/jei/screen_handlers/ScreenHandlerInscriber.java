...
public class ScreenHandlerInscriber implements IGuiContainerHandler<ScreenInscriber> {

	@Override
	public List<Rect2i> getGuiExtraAreas(ScreenInscriber containerScreen) {
