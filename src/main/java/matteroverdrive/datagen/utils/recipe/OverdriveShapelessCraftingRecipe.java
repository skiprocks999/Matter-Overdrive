...
public class OverdriveShapelessCraftingRecipe extends ShapelessRecipeBuilder.Result {
	...
	private OverdriveShapelessCraftingRecipe(ResourceLocation recipeId, Item result, int count, List<Ingredient> ingredients) {
	...
	public static class Builder {
		...
		public void complete(String parent, String name, Consumer<FinishedRecipe> consumer){
			consumer.accept(new OverdriveShapelessCraftingRecipe(new ResourceLocation(parent, name), item, count, ingredients));
		}
