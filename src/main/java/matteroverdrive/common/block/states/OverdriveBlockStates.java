...
public class OverdriveBlockStates {
	...
	public static final EnumProperty<ChargerBlockPos> CHARGER_POS = EnumProperty.create("charger_pos", ChargerBlockPos.class);
	
	public static final EnumProperty<CableConnectionType> CABLE_DOWN = EnumProperty.create("cable_down", CableConnectionType.class);
	public static final EnumProperty<CableConnectionType> CABLE_UP = EnumProperty.create("cable_up", CableConnectionType.class);
	public static final EnumProperty<CableConnectionType> CABLE_NORTH = EnumProperty.create("cable_north", CableConnectionType.class);
	public static final EnumProperty<CableConnectionType> CABLE_SOUTH = EnumProperty.create("cable_south", CableConnectionType.class);
