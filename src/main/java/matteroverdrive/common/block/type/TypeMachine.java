...
public enum TypeMachine {
	...
	CHARGER(new VoxelShape[] { Shapes.block(), Shapes.block(), VoxelShapes.CHARGER_N, VoxelShapes.CHARGER_S,
			VoxelShapes.CHARGER_E, VoxelShapes.CHARGER_W }, true),
	...
	SPACETIME_ACCELERATOR(Block.box(4.0D, 0.0D, 4.0D, 12.0D, 16.0D, 12.0D), true), CHUNKLOADER(true),
	MATTER_ANALYZER(true), PATTERN_STORAGE(true),
